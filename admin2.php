...
<body>
    ...
    <h1 class="addMov">Add Movie (Coming Soon)</h1>

    <form action="admin2_db.php" method="post">
        ...
        <div class="mb-3" id="first">
            ...
            <input type="text" class="form-control" name="cname" aria-describedby="firstname" id="infirst">
        </div>
        <div class="mb-3" id="sec">
            <label for="firstname" class="form-label">Add movie lenght</label>
            <input type="text" class="form-control" name="clength" aria-describedby="firstname" id="infirst">
        </div>
        <div class="mb-3" id="thrid">
            <label for="firstname" class="form-label">Add type of movie</label>
            <input type="text" class="form-control" name="ctype" aria-describedby="firstname" id="type">
        </div>
        <div class="mb-3" id="four">
            <label for="firstname" class="form-label">Add date of movie show</label>
            <input type="text" class="form-control" name="crelease" aria-describedby="firstname" id="infirst">
        </div>
        <div class="mb-3" id="fif">
            <label for="firstname" class="form-label">Add detail of movie</label>
            <input type="text" class="form-control" name="cdetail" aria-describedby="firstname" id="detail">
        </div>
        <div class="mb-3" id="six">
            <label for="firstname" class="form-label">Add actor</label>
            <input type="text" class="form-control" name="cactor" aria-describedby="firstname" id="actor">
        </div>
        <div class="mb-3" id="sev">
            <label for="firstname" class="form-label">Add image</label>
            <input type="text" class="form-control" name="cimage" aria-describedby="firstname" id="infirst">
        </div>
        <div class="mb-3" id="eig">
            <label for="firstname" class="form-label">Add director</label>
            <input type="text" class="form-control" name="cdirector" aria-describedby="firstname" id="infirst">
        </div>
        <div class="but">
            <button type="submit" class="btn" id="signup" name="addcoming"><a>ADD MOVIE</a></button>
        </div>
